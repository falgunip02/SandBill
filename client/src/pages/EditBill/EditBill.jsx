...
const EditBill = () => {
    ...
    if (!bill) return <div className="error-container">Bill not found</div>;

    return (
        <div className="edit-bill-container">
            <h1 className="edit-bill-title">Edit Bill</h1>
            ...
            <form onSubmit={handleSubmit} className="edit-bill-form">
                <div className="form-grid">
                    ...
                    <div className="form-group">
                        <label htmlFor="balanceBillingAmount">Balance Billing Amount (₹)</label>
                        <input
                            id="balanceBillingAmount"
                            type="number"
                            name="balanceBillingAmount"
                            value={calculateBalance(bill.estimateAmount, bill.billedAmount)}
                            readOnly
